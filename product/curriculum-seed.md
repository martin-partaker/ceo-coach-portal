# CEO Coaching Portal — Curriculum Seed Content

> This file contains the content to be seeded into the `curriculum` table in Neon Postgres.
> Each section below = one row in the curriculum table.
> Coaches and the AI use this as the framework reference embedded in the system prompt.
>
> Based on: Eric Partaker's IPA framework, CEO Accelerator, The 3 Alarms, Peak Performance Program.
> Status: Placeholder — refine with real EP team content before production.

---

## SEED ROW 1 — The IPA Framework (Core)

**Title:** The IPA Framework — Identity, Productivity, Antifragility

**Content:**
The IPA Framework is the foundation of the CEO coaching program. It operates across three pillars:
...
**In coaching sessions:** Always anchor feedback and next steps to one of the three pillars. A missed commitment is an identity question. A chaotic week is a productivity question. A avoided conversation is an antifragility question.

---

## SEED ROW 2 — The 10x Goal Framework

**Title:** The 10x Goal — Setting and Tracking the North Star

**Content:**
The 10x Goal is the CEO's defining long-term ambition — the outcome that would represent a non-linear leap in the business or their leadership. It is not a 10% improvement. It requires fundamentally different thinking, different constraints, and different identity.
...
**Coaching use:** Every session starts with the 10x goal visible. Monthly summaries must connect back to it. If monthly goals are not clearly in service of the 10x goal, that is the first thing to address.
...
## SEED ROW 3 — Monthly Cycle Structure

**Title:** The Monthly Coaching Cycle — Commitments, Progress, and Next Steps

**Content:**
Each coaching cycle is structured around a rhythm of commitment and accountability. The cycle is not strictly a calendar month — it is the period between coaching sessions.
...
## SEED ROW 4 — The 3 Life Domains

**Title:** The 3 Life Domains — Health, Wealth, Relationships

**Content:**
Sustainable high performance requires balance across three domains. A CEO who is winning at work but losing at health or relationships is not operating at their best — it always catches up.
...
- "What's one health non-negotiable you committed to — did you keep it?"
...
**Coaching use:** Monthly summaries acknowledge all three domains. Do not let sessions become exclusively about business metrics. Ask about health and relationships at least once per cycle.

---

## SEED ROW 5 — Identity Work for CEOs

**Title:** Identity-Based Change — Becoming the CEO Your Company Needs

**Content:**
Eric Partaker's core insight: behavior change is hard. Identity change is where sustainable performance begins.

**The identity question:** "Who do you need to be — consistently — to achieve your 10x goal?"

**The process:**
1. Define your "best self CEO" — the version of you operating at your highest level. Name them if helpful.
...
4. When you act inconsistently with your identity, ask: "Would [best self CEO] do this?"

**Common CEO identity gaps:**
- The expert who hasn't yet become a leader (still solving problems rather than building the team that solves them)
- The founder who hasn't yet become a CEO (still doing, not setting direction)
- The high performer who hasn't yet built recovery into their identity (burning out because rest feels like weakness)

**Coaching language:** Use "who you're becoming" not "what you need to do." Frame feedback as identity observations, not behavioral criticism. "It sounds like part of you is still operating as the expert rather than the CEO — what would the CEO version of you have done here?"

---

## SEED ROW 6 — Accountability and Commitment Framework

**Title:** Accountability — The Commitment Loop

**Content:**
Accountability is not about pressure — it is about creating a system where commitments are taken seriously and learning is extracted from every outcome.
...
Do not gloss over missed commitments. Acknowledge them directly, explore what got in the way, and use it as signal. Common patterns:
- Overcommitting (too many commitments each cycle)
- External constraint not identified in advance
- Competing priorities not resolved
...
- "What would get in the way, and how will you handle that?"

---

## SEED ROW 7 — Constraint Identification

**Title:** Finding and Removing Constraints

**Content:**
The Theory of Constraints applied to CEO coaching: at any given time, there is one bottleneck limiting progress toward the 10x goal. Identifying and removing that constraint is the highest-leverage action available.
...
**Coaching use:** The monthly summary should always name the primary constraint operating in that cycle, even if implicitly. Suggested next steps should address the constraint directly.

---

## SEED ROW 8 — Session 1 Checklist

**Title:** First Coaching Session — Onboarding Checklist

**Content:**
The first session with a new CEO sets the tone for the entire coaching relationship. Cover the following:
...
5. **First commitments** — What 3–5 specific commitments will they make for the first cycle? Write them down.

6. **Rhythm** — Agree on the weekly journal cadence, monthly reflection, and session frequency.

7. **Coaching agreement** — Set expectations: sessions are for accountability, honesty, and forward momentum. The coach asks hard questions. The CEO does the work.

---

## SEED ROW 9 — Question Bank by Stage
...
- "Who else needs to know about this commitment to help hold you to it?"
...
## How to Use This Curriculum in AI Generation

When generating a coaching summary, the AI should:

1. Reference the CEO's 10x goal explicitly in the Progress Summary
2. Frame challenges as constraints (not failures or character flaws)
3. Connect suggested next steps back to the 10x goal or primary constraint
4. Use Eric Partaker's language: "best self," "champion proof," "commitment," "leverage," "constraint," "showing up as"
5. Acknowledge progress in identity terms, not just output terms
6. Always include the commitment loop: what was committed → what happened → what next
7. Tone: Professional, reflective, coach-aligned. Warm but direct. Never therapeutic or diagnostic.
