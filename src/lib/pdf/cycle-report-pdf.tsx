...
export function CycleReportPdf({ data }: { data: CycleReportPdfData }) {
  ...
  // Coach name intentionally omitted from the CEO-facing subtitle (client
  // request — the "Coach: …" line and the old "generated by" footer are
  // internal metadata, not for the CEO copy).
